...
/*******/
  ...
  getContactosXls(){
      this.loading = true;
      this.service.getPrimerContactoXls(0, 0, this.calendarFormGroup.controls.fechaCierre.value, this.sortAsc, this.sortField, this.region, this.distritosUsuario, 'todos', this.usuarioId, this.hasRol("Lider Regional"), false);
      this.loading = false;
  }
